...
from include.transform.queries import (read_data_into_orders_table, write_to_silver_layer,
...
class loadCustomersToSilver(BaseOperator): 
    ...
    def execute(self, context):
        ...
        self.conn.sql(read_data_into_orders_table('mytek_orders', self.current_timestamp.year,
